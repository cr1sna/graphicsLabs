...
xwmin = int(input('Enter clippiing window starting x co-ordinate'))
ywmin = int(input('Enter clipping window starting y co-ordinate'))
xwmax = int(input('Enter clipping window ending x co-ordinate'))
ywmax = int(input('Enter clipping window ending y co-ordinate'))
